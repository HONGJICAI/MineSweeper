...
impl<R: Runtime> GoogleAdmob<R> {
    ...
    pub fn request_consent(
        ...
        self.0
            .run_mobile_plugin("request_consent", payload)
            .map_err(Into::into)
    }

    pub fn get_consent_status(&self) -> crate::Result<ConsentResponse> {
        self.0
            .run_mobile_plugin::<ConsentResponse>("get_consent_status", ())
            .map_err(Into::into)
    }

    pub fn show_privacy_options_form(&self) -> crate::Result<ShowPrivacyOptionsResponse> {
        self.0
            .run_mobile_plugin::<ShowPrivacyOptionsResponse>("show_privacy_options_form", ())
            .map_err(Into::into)
    }
