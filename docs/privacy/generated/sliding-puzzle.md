...
This privacy policy applies to the Sliding Puzzle app for mobile devices (the "Application") operated by Cai Ji (the "Service Provider").
...
No personal data is collected, and none is transferred to any third party.
...
Because the Application collects no personal information, there is nothing to access, delete, correct, or opt out of. If you are a resident of a U.S. state with a comprehensive consumer privacy law and have questions, contact support@caiji.dev.
...
The Application is a native mobile application and does not set or use HTTP cookies. The Application contains no third-party tracking SDKs.
